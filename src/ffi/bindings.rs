...
extern "C" {
    pub fn SystemSetCpuClk(CpuClk: ffi::ctypes::c_uchar);
}
extern "C" {
...
pub type FTL_LEVEL_DEFINE = ffi::ctypes::c_uint;
...
pub type T_FTL_IOCTL_CODE = ffi::ctypes::c_uint;
extern "C" {
...
extern "C" {
    pub fn ftl_save_to_storage(pdata: *mut ffi::ctypes::c_void, offset: u16, size: u16) -> u32;
}
extern "C" {
    pub fn ftl_load_from_storage(pdata: *mut ffi::ctypes::c_void, offset: u16, size: u16) -> u32;
}
extern "C" {
...
pub type PendedFunction_t =
    ::core::option::Option<unsafe extern "C" fn(arg1: *mut ffi::ctypes::c_void, arg2: u32)>;
extern "C" {
    pub fn xTimerCreate(
        pcTimerName: *const ffi::ctypes::c_char,
        xTimerPeriodInTicks: TickType_t,
        uxAutoReload: UBaseType_t,
        pvTimerID: *mut ffi::ctypes::c_void,
        pxCallbackFunction: TimerCallbackFunction_t,
    ) -> TimerHandle_t;
}
extern "C" {
    pub fn pvTimerGetTimerID(xTimer: TimerHandle_t) -> *mut ffi::ctypes::c_void;
}
extern "C" {
    pub fn vTimerSetTimerID(xTimer: TimerHandle_t, pvNewID: *mut ffi::ctypes::c_void);
}
extern "C" {
...
extern "C" {
    pub fn xTimerPendFunctionCallFromISR(
        ...
        pvParameter1: *mut ffi::ctypes::c_void,
        ulParameter2: u32,
        pxHigherPriorityTaskWoken: *mut BaseType_t,
    ) -> BaseType_t;
}
...
extern "C" {
    pub fn pcTimerGetName(xTimer: TimerHandle_t) -> *const ffi::ctypes::c_char;
}
extern "C" {
...
extern "C" {
    pub fn vEventGroupSetBitsCallback(pvEventGroup: *mut ffi::ctypes::c_void, ulBitsToSet: u32);
}
extern "C" {
    pub fn vEventGroupClearBitsCallback(pvEventGroup: *mut ffi::ctypes::c_void, ulBitsToClear: u32);
}
extern "C" {
    pub fn uxEventGroupGetNumber(xEventGroup: *mut ffi::ctypes::c_void) -> UBaseType_t;
}
extern "C" {
    pub fn vEventGroupSetNumber(
        xEventGroup: *mut ffi::ctypes::c_void,
        uxEventGroupNumber: UBaseType_t,
    );
}
pub type osdepCHAR = ffi::ctypes::c_char;
pub type osdepFLOAT = f32;
pub type osdepDOUBLE = f64;
pub type osdepLONG = ffi::ctypes::c_long;
pub type osdepSHORT = ffi::ctypes::c_short;
pub type osdepSTACK_TYPE = ffi::ctypes::c_ulong;
pub type osdepBASE_TYPE = ffi::ctypes::c_long;
pub type osdepTickType = ffi::ctypes::c_ulong;
pub type _timerHandle = *mut ffi::ctypes::c_void;
pub type _sema = *mut ffi::ctypes::c_void;
pub type _mutex = *mut ffi::ctypes::c_void;
pub type _lock = *mut ffi::ctypes::c_void;
pub type _queueHandle = *mut ffi::ctypes::c_void;
pub type _xqueue = *mut ffi::ctypes::c_void;
...
pub type _buffer = ffi::ctypes::c_uchar;
pub type systime = ffi::ctypes::c_uint;
#[repr(C)]
#[derive(Debug, Copy, Clone)]
pub struct __queue {
    pub queue: list_head,
...
pub type _irqL = ffi::ctypes::c_ulong;
pub type _thread_hdl_ = *mut ffi::ctypes::c_void;
pub type thread_return = ffi::ctypes::c_void;
pub type thread_context = *mut ffi::ctypes::c_void;
#[repr(C)]
#[derive(Debug, Default, Copy, Clone)]
pub struct atomic_t {
    pub counter: ffi::ctypes::c_int,
}
extern "C" {
    pub fn save_and_cli();
}
...
extern "C" {
    pub fn rtw_if_wifi_thread(name: *mut ffi::ctypes::c_char) -> ffi::ctypes::c_int;
}
extern "C" {
...
pub struct timer_list {
    ...
    pub data: ffi::ctypes::c_ulong,
    pub function: ::core::option::Option<unsafe extern "C" fn(arg1: *mut ffi::ctypes::c_void)>,
}
...
pub type TIMER_FUN =
    ::core::option::Option<unsafe extern "C" fn(context: *mut ffi::ctypes::c_void)>;
...
pub struct task_struct {
    pub task_name: *const ffi::ctypes::c_char,
...
extern "C" {
    pub fn init_mem_monitor(pmem_table: *mut _list, used_num: *mut ffi::ctypes::c_int);
}
extern "C" {
    pub fn deinit_mem_monitor(pmem_table: *mut _list, used_num: *mut ffi::ctypes::c_int);
}
extern "C" {
    pub fn add_mem_usage(
        pmem_table: *mut _list,
        ptr: *mut ffi::ctypes::c_void,
        size: ffi::ctypes::c_int,
        used_num: *mut ffi::ctypes::c_int,
        flag: ffi::ctypes::c_int,
    );
}
extern "C" {
...
extern "C" {
    pub fn get_mem_usage(pmem_table: *mut _list) -> ffi::ctypes::c_int;
}
extern "C" {
...
extern "C" {
    pub fn rtw_memcpy(dst: *mut ffi::ctypes::c_void, src: *mut ffi::ctypes::c_void, sz: u32);
}
extern "C" {
    pub fn rtw_memcmp(
        dst: *mut ffi::ctypes::c_void,
        src: *mut ffi::ctypes::c_void,
        sz: u32,
    ) -> ffi::ctypes::c_int;
}
extern "C" {
    pub fn rtw_memset(pbuf: *mut ffi::ctypes::c_void, c: ffi::ctypes::c_int, sz: u32);
}
extern "C" {
    pub fn rtw_init_sema(sema: *mut _sema, init_val: ffi::ctypes::c_int);
}
extern "C" {
...
extern "C" {
    pub fn rtw_mutex_get_timeout(pmutex: *mut _mutex, timeout_ms: u32) -> ffi::ctypes::c_int;
}
extern "C" {
...
extern "C" {
    pub fn rtw_enter_critical_mutex(pmutex: *mut _mutex, pirqL: *mut _irqL) -> ffi::ctypes::c_int;
}
extern "C" {
...
extern "C" {
    pub fn rtw_deinit_xqueue(queue: *mut _xqueue) -> ffi::ctypes::c_int;
}
extern "C" {
...
extern "C" {
    pub fn rtw_msleep_os(ms: ffi::ctypes::c_int);
}
extern "C" {
    pub fn rtw_usleep_os(us: ffi::ctypes::c_int);
}
extern "C" {
    pub fn rtw_atoi(s: *mut u8) -> u32;
}
extern "C" {
    pub fn rtw_mdelay_os(ms: ffi::ctypes::c_int);
}
extern "C" {
    pub fn rtw_udelay_os(us: ffi::ctypes::c_int);
}
extern "C" {
    pub fn rtw_yield_os();
}
extern "C" {
    pub fn ATOMIC_SET(v: *mut atomic_t, i: ffi::ctypes::c_int);
}
extern "C" {
    pub fn ATOMIC_READ(v: *mut atomic_t) -> ffi::ctypes::c_int;
}
extern "C" {
    pub fn ATOMIC_ADD(v: *mut atomic_t, i: ffi::ctypes::c_int);
}
extern "C" {
    pub fn ATOMIC_SUB(v: *mut atomic_t, i: ffi::ctypes::c_int);
}
extern "C" {
...
extern "C" {
    pub fn ATOMIC_ADD_RETURN(v: *mut atomic_t, i: ffi::ctypes::c_int) -> ffi::ctypes::c_int;
}
extern "C" {
    pub fn ATOMIC_SUB_RETURN(v: *mut atomic_t, i: ffi::ctypes::c_int) -> ffi::ctypes::c_int;
}
extern "C" {
    pub fn ATOMIC_INC_RETURN(v: *mut atomic_t) -> ffi::ctypes::c_int;
}
extern "C" {
    pub fn ATOMIC_DEC_RETURN(v: *mut atomic_t) -> ffi::ctypes::c_int;
}
extern "C" {
    pub fn ATOMIC_DEC_AND_TEST(v: *mut atomic_t) -> ffi::ctypes::c_int;
}
extern "C" {
    pub fn rtw_modular64(x: u64, y: u64) -> u64;
}
extern "C" {
    pub fn rtw_get_random_bytes(dst: *mut ffi::ctypes::c_void, size: u32) -> ffi::ctypes::c_int;
}
extern "C" {
...
extern "C" {
    pub fn rtw_set_priority_task(task: *mut ffi::ctypes::c_void, NewPriority: u32);
}
extern "C" {
    pub fn rtw_get_priority_task(task: *mut ffi::ctypes::c_void) -> ffi::ctypes::c_int;
}
extern "C" {
    pub fn rtw_suspend_task(task: *mut ffi::ctypes::c_void);
}
extern "C" {
    pub fn rtw_resume_task(task: *mut ffi::ctypes::c_void);
}
extern "C" {
...
extern "C" {
    pub fn rtw_delete_worker_thread(worker_thread: *mut rtw_worker_thread_t) -> ffi::ctypes::c_int;
}
extern "C" {
    pub fn rtw_thread_enter(name: *mut ffi::ctypes::c_char);
}
extern "C" {
...
extern "C" {
    pub fn rtw_timerCreate(
        pcTimerName: *const ffi::ctypes::c_schar,
...
extern "C" {
    pub fn rtw_timerGetID(xTimer: _timerHandle) -> *mut ffi::ctypes::c_void;
}
extern "C" {
...
pub struct osdep_service_ops {
    ...
    pub rtw_memcpy: ::core::option::Option<
        unsafe extern "C" fn(dst: *mut ffi::ctypes::c_void, src: *mut ffi::ctypes::c_void, sz: u32),
    >,
    ...
    pub rtw_memset: ::core::option::Option<
        unsafe extern "C" fn(pbuf: *mut ffi::ctypes::c_void, c: ffi::ctypes::c_int, sz: u32),
    >,
    pub rtw_init_sema: ::core::option::Option<
        unsafe extern "C" fn(sema: *mut _sema, init_val: ffi::ctypes::c_int),
    >,
    ...
    pub rtw_mutex_get_timeout: ::core::option::Option<
        unsafe extern "C" fn(pmutex: *mut _mutex, timeout_ms: u32) -> ffi::ctypes::c_int,
    >,
    ...
    pub rtw_enter_critical_mutex: ::core::option::Option<
        unsafe extern "C" fn(pmutex: *mut _mutex, pirqL: *mut _irqL) -> ffi::ctypes::c_int,
    >,
    ...
    pub rtw_deinit_xqueue:
        ::core::option::Option<unsafe extern "C" fn(queue: *mut _xqueue) -> ffi::ctypes::c_int>,
    ...
    pub rtw_msleep_os: ::core::option::Option<unsafe extern "C" fn(ms: ffi::ctypes::c_int)>,
    pub rtw_usleep_os: ::core::option::Option<unsafe extern "C" fn(us: ffi::ctypes::c_int)>,
    pub rtw_mdelay_os: ::core::option::Option<unsafe extern "C" fn(ms: ffi::ctypes::c_int)>,
    pub rtw_udelay_os: ::core::option::Option<unsafe extern "C" fn(us: ffi::ctypes::c_int)>,
    pub rtw_yield_os: ::core::option::Option<unsafe extern "C" fn()>,
    pub ATOMIC_SET:
        ::core::option::Option<unsafe extern "C" fn(v: *mut atomic_t, i: ffi::ctypes::c_int)>,
    pub ATOMIC_READ:
        ::core::option::Option<unsafe extern "C" fn(v: *mut atomic_t) -> ffi::ctypes::c_int>,
    pub ATOMIC_ADD:
        ::core::option::Option<unsafe extern "C" fn(v: *mut atomic_t, i: ffi::ctypes::c_int)>,
    pub ATOMIC_SUB:
        ::core::option::Option<unsafe extern "C" fn(v: *mut atomic_t, i: ffi::ctypes::c_int)>,
    ...
    pub ATOMIC_ADD_RETURN: ::core::option::Option<
        unsafe extern "C" fn(v: *mut atomic_t, i: ffi::ctypes::c_int) -> ffi::ctypes::c_int,
    >,
    ...
    pub rtw_get_random_bytes: ::core::option::Option<
        unsafe extern "C" fn(dst: *mut ffi::ctypes::c_void, size: u32) -> ffi::ctypes::c_int,
    >,
    ...
    pub rtw_set_priority_task: ::core::option::Option<
        unsafe extern "C" fn(task: *mut ffi::ctypes::c_void, NewPriority: u32),
    >,
    pub rtw_get_priority_task: ::core::option::Option<
        unsafe extern "C" fn(task: *mut ffi::ctypes::c_void) -> ffi::ctypes::c_int,
    >,
    pub rtw_suspend_task:
        ::core::option::Option<unsafe extern "C" fn(task: *mut ffi::ctypes::c_void)>,
    pub rtw_resume_task:
        ::core::option::Option<unsafe extern "C" fn(task: *mut ffi::ctypes::c_void)>,
    pub rtw_thread_enter:
        ::core::option::Option<unsafe extern "C" fn(name: *mut ffi::ctypes::c_char)>,
    ...
    pub rtw_timerGetID: ::core::option::Option<
        unsafe extern "C" fn(xTimer: _timerHandle) -> *mut ffi::ctypes::c_void,
    >,
    ...
    pub rtw_get_current_TaskHandle:
        ::core::option::Option<unsafe extern "C" fn() -> *mut ffi::ctypes::c_void>,
}
#[repr(C)]
#[derive(Debug, Copy, Clone)]
pub struct _PsramMemChunk {
    pub next: *mut _PsramMemChunk,
    pub size: ffi::ctypes::c_int,
}
...
extern "C" {
    pub fn Psram_heap_allocmem(size: ffi::ctypes::c_int) -> *mut ffi::ctypes::c_void;
}
extern "C" {
    pub fn Psram_reserved_heap_freemem(mem: *mut ffi::ctypes::c_void, size: ffi::ctypes::c_int);
}
extern "C" {
    pub fn Psram_reserve_free_size() -> ffi::ctypes::c_int;
}
extern "C" {
    pub fn Psram_reserve_malloc(size: ffi::ctypes::c_int) -> *mut ffi::ctypes::c_void;
}
extern "C" {
    pub fn Psram_reserve_calloc(
        num: ffi::ctypes::c_int,
        size: ffi::ctypes::c_int,
    ) -> *mut ffi::ctypes::c_void;
}
extern "C" {
    pub fn Psram_reserve_free(mem: *mut ffi::ctypes::c_void);
}
extern "C" {
    pub static mut g_Psram_heap_inited: ffi::ctypes::c_int;
}
...
extern "C" {
    pub fn netbuf_alloc(buf: *mut netbuf, size: u16_t) -> *mut ffi::ctypes::c_void;
}
extern "C" {
    pub fn netbuf_free(buf: *mut netbuf);
}
extern "C" {
    pub fn netbuf_ref(buf: *mut netbuf, dataptr: *const ffi::ctypes::c_void, size: u16_t) -> err_t;
}
extern "C" {
...
extern "C" {
    pub fn netbuf_data(
        buf: *mut netbuf,
        dataptr: *mut *mut ffi::ctypes::c_void,
        len: *mut u16_t,
    ) -> err_t;
}
extern "C" {
...
pub type netconn_type = ffi::ctypes::c_uint;
...
pub type netconn_state = ffi::ctypes::c_uint;
...
pub struct netconn {
    ...
    pub socket: ffi::ctypes::c_int,
    pub recv_timeout: ffi::ctypes::c_int,
    pub flags: u8_t,
...
extern "C" {
    pub fn netconn_gethostbyname(name: *const ffi::ctypes::c_char, addr: *mut ip_addr_t) -> err_t;
}
#[repr(C)]
#[derive(Debug, Default, Copy, Clone)]
pub struct in_addr {
...
pub type dns_found_callback = ::core::option::Option<
    unsafe extern "C" fn(
        ...
        callback_arg: *mut ffi::ctypes::c_void,
    ),
>;
extern "C" {
    pub fn dns_init();
...
extern "C" {
    pub fn inet_chksum(dataptr: *const ffi::ctypes::c_void, len: u16_t) -> u16_t;
}
extern "C" {
