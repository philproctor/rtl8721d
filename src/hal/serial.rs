    ...
    > SerialPort<TX, RX, BAUD, PARITY>
{
    ...
    pub unsafe fn init(&self) {
        ...
        c::serial_irq_handler(cptr, Some(Self::irq_rx), self.u32_addr());
        c::serial_irq_set(cptr, c::SerialIrq_RxIrq, 1);
    }

    fn u32_addr(&self) -> u32 {
        unsafe { core::mem::transmute::<&Self, u32>(&self) }
    }

    unsafe fn from_u32(addr: u32) -> &'static Self {
        core::mem::transmute::<u32, &Self>(addr)
    }
